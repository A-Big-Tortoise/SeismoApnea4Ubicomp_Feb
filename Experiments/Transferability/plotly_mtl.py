...
if __name__ == "__main__":
	...
	model_folder_name = f'{XYZ}_60s_F1_ws1_wa1_room'
	...
	for idx in range(1, 5):
		...
		for file in sorted(os.listdir(data_folder)):
			...
			print(f'Processing Patient ID: {ID_npy} in fold {fold_idx}..., i={idx}')
			if fold_idx != str(idx):
				continue
		...
		path = f'Experiments/{Experiment}/Models/{model_folder_name}/Room{idx}_AHI_{step_sig_apn//10}s_larger2_change106108134_change29_no153119241149932_with108'
		sleep_path = f'Experiments/{Experiment}/Models/{model_folder_name}/Room{idx}_TST_{step_sig_sleep//10}s_larger2_change106108134_change29_no153119241149932_with108'
