...
if __name__ == "__main__":
	...
	for cnt, url in enumerate(selected_urls):
		...
		start_time = unix_start_time + 15 + start_latency
		end_time = start_time + 60

		start_time_bsg = unix_start_time + 15
		...
		plt.xlabel('Time [sec]')
		plt.tight_layout()
		plt.savefig(f'/home/jiayu/SeismoApnea4Ubicomp_Feb/Infos/figs_An/{TYPE}_comparison.png', bbox_inches='tight', dpi=300)
		plt.close()
