...
if __name__ == "__main__":
	...
	for fold_idx in range(1, 5):
		model_save_fold_name = f'Models/{args.XYZ}_60s_{args.threhold}_ws{args.lambda_s}_wa{args.lambda_a}_REC{args.lambda_rec}_export/fold{fold_idx}/'
		...
		# data_path = f'Data/fold_data_p109_{Type}_45s_minus1/'
